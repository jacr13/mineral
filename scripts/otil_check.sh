...
# # OTIL - RollingFlat
# python -m mineral.scripts.run \
# task=Rewarped agent=RewarpedJumperOTIL task.env.env_name=RollingPin task.env.env_suite=plasticinelab \
...
# # OTIL - SoftJumper
# python -m mineral.scripts.run \
# task=Rewarped agent=RewarpedJumperOTIL task.env.env_name=Jumper task.env.env_suite=gradsim \
...
# OTIL - HandFlip
python -m mineral.scripts.run \
task=Rewarped agent=RewarpedJumperOTIL task.env.env_name=Flip task.env.env_suite=dexdeform \
...
agent.otil.demos_path="aadaf"


# # # OTIL - FluidMove
# # python -m mineral.scripts.run \
# # task=Rewarped agent=RewarpedJumperOTIL task.env.env_name=Transport task.env.env_suite=softgym \
